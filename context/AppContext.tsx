    ...
    setConversations((prev) => {
      ...
      if (existing) {
        ...
        const newConv: Conversation = {
          ...
          landlordId: prop?.ownerId || (currentRole === 'LANDLORD' ? currentUser.id : landlordUser.id),
          landlordName: prop?.ownerName || (currentRole === 'LANDLORD' ? currentUser.name : landlordUser.name),
          tenantId: currentRole === 'TENANT' ? currentUser.id : tenantUser.id,
          tenantName: currentRole === 'TENANT' ? currentUser.name : tenantUser.name,
